...
function b() {
    ...
    a.addEventListener("keyup", p, false);
    a.addEventListener("paste", p, false);
    p()
}
function s() {
    document.getElementById("mainLang").addEventListener("change",
    function () {
        n("1")
    },
    false);
    ...
    false);
    document.getElementsByClassName("button")[2].addEventListener("click",
    function () {
        n("5")
    },
    false);
    ...
    false);
    document.getElementsByClassName("opt_select")[2].addEventListener("change",
    function () {
        n("6")
    },
    false);
    document.getElementsByClassName("opt_button")[0].addEventListener("click",
    function () {
        p()
    },
    false);
    ...
    var a = chrome.extension.getURL("controls.png");
    ...
    a =
    document.getElementById("mainLang");
    var c = document.getElementById("realLang"),
    g = document.getElementById("srcLang"),
    h = "";
    for (var f in google.language.Languages) if (google.language.Languages[f] != "") h += '<option value="' + google.language.Languages[f] + '">' + f.substring(0, 1) + f.substring(1).toLowerCase().replace("_", " ") + "</option>";
    a.innerHTML = h;
    c.innerHTML = h;
    g.innerHTML = h;
    r(a, "-", "separator", true);
