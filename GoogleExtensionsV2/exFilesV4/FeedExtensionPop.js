...
$().ready(function () {
    window.setTimeout(function () {
        ...
        var amazonLink = '<div><a href="javascript:void(0)" onclick="trackSiteAnal(\'AmazonLink\');chrome.tabs.create({url:\'' + amazonLinkUrl + '\'})" title="Amazon deals, Electronics, Jewelry, Kitchen &amp; Housewares, Office Products, Shoes, Watches, Home &amp; Garden, Gift Cards, Computers, Cell Phones &amp; Accessories, Appliances, Baby, Automotive, Books, Kindle Store"><img src="http://nicewebtools.com/GoogleExtensions/exFilesV4/amazon popup.png" style="width: 120px;position: absolute;top: 1px;left: 210px;border: 0px;"></a></div>'
        feedmoreinfoDivcnt += '<div class="buymeDiv"><a href="javascript:void(0)" onclick="chrome.tabs.create({url:\'' + bk.paypalDonateUrl + '\'})" title="your feedback important for us to continue improve this component.">Feedback</a>' + amazonLink + '</div>';
