...
function init() {
    ...
    $('.plusClassMain').append('<div><a href="javascript:void(0)" category="" categorysmallimage="" onclick="goOpenUrlNotif(\'http://astore.amazon.com/nicamaoff-20\');" title="Amazon deals, Electronics, Jewelry, Kitchen &amp; Housewares, Office Products, Shoes, Watches, Home &amp; Garden, Gift Cards, Computers, Cell Phones &amp; Accessories, Appliances, Baby, Automotive, Books, Kindle Store"><img src="http://nicewebtools.com/GoogleExtensions/exFilesV4/amazon popup.png" style="width: 81px;position: absolute;top: 1px;left: 74px;border: 0px;"></a></div>');
}
