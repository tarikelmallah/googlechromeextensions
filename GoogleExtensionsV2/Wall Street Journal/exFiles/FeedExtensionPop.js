...
$().ready(function () {
    ...
    feedmoreinfoDivcnt += '<div class="buymeDiv"><a href="javascript:void(0)" onclick="chrome.tabs.create({url:\'' + bk.paypalDonateUrl + '\'})" title="Buy me a cup of coffee" id="link-buyme">Buy me a cup of coffee</a></div>';
